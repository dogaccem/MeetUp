...
{
    /// <inheritdoc />
    public partial class updatedEntitiesV1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RespondBy = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_EventDetail_EventDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendedEvent", x => new { x.EventId, x.ApplicationUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteEvent", x => new { x.EventId, x.ApplicationUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendedEvent_ApplicationUserId",
                table: "AttendedEvent",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteEvent_ApplicationUserId",
                table: "FavoriteEvent",
                column: "ApplicationUserId");
        }
